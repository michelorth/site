  ...
  return (
    <Box {...sectionWrapper} as="section">
      <Container>
        <NewsletterWrapper>
          <Box {...textArea}>
            <Heading content="Fortaleça a Indústria por meio da transformação digital." {...title} />
            <br/>
            <Text
              content="A sua Indústria precisa otimizar processos a fim de ganhar em produtividade, redução de custos e previsibilidade nos processos de RH, DP e Contabilidade."
              {...description}
            />
            <br/>
            <Text
              content="Faça acompanhamento remoto da jornada dos colaboradores da sua empresa com o Ponto Eletrônico Icarus."
              {...description}
            />
            <br/>
            <Text
              content="Tenha na palma da sua mão respostas rápidas e precisas, através de uma plataforma com alta flexibilidade para potencializar os resultados da sua empresa."
              {...description}
            />
            <br/>
            <Text
