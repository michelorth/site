...
import PricingTable, {
  ListItem, PricingButton, PricingButtonWrapper, PricingHead, PricingList, PricingPrice
} from './pricing.style';
...
const GlideSlide = loadable(() => import('common/components/GlideCarousel/glideSlide'));
...
const PricingSection = ({
  ...
  return (
    <Box {...sectionWrapper} id="tabela_precos">
      <Container>
        <Box {...secTitleWrapper}>
          <Text {...secText} content="PLANOS" />
          <Heading
            {...secHeading}
            content="Escolha o Tipo da Assinatura"
          />
