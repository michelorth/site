...
import Logotipo from 'common/assets/image/saasModern/logo-white.webp';
    ...
    <BannerWrapper id="banner_section">
      ...
      <Container>
        ...
        <Grid container spacing={6}>
          ...
          <Box {...contentWrapper}>
            <Box {...buttonWrapper}>
              <Image src={Logotipo} alt="Sistema de Ponto Eletrônico" style={{width: 244, height: 104}} />
            </Box>
            <br/><br/>
            <Heading
              as='h1'
              {...title}
              content="A Ponto Icarus entende a necessidade das empresas Petrolíferas e está preparada para te ajudar!"
            />

          <Text
              {...description}
              content="Temos a MELHOR SOLUÇÃO do mercado em REGISTRO DE PONTO ELETRÔNICO para atender às necessidades de praticidade e segurança que garantem os direitos e deveres de empresas e colaboradores."
            />
