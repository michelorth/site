  ...
  return (
    <Box {...sectionWrapper} as="section">
      <Container>
        <NewsletterWrapper>
          <Box {...textArea}>
            <Heading content="Quer Saber Mais?" {...title} />
            <Text
              content="Ofereça segurança e praticidade aos seus colaboradores na primeira e última tarefa do dia!"
              {...description}
            />
            <br/>
            <Text
              content="Nosso time de especialistas está preparado para auxiliar as empresas petrolíferas em seus desafios! Através de um sistema eficiente, a sua empresa pode otimizar a gestão de tempo e reduzir recursos!"
              {...description}
            />
            <br/>
            <Text
              content="Diga OLÁ para a sua mais nova gestão eficiente de jornada do colaborador!"
              {...description}
            />
            <br/>
            <Text
              content="Registro de Ponto? Nunca mais tenha problemas com essa tarefa!"
              {...description}
            />
             <br/>
            <Text
              content="Preencha o formulário que vamos entrar em contato com você!"
              {...description}
            />
            <br/>
            <Text
